  ...
  return (
    <div className="h-screen w-full flex overflow-hidden relative">
      <div className="w-16 h-full border-r border-black/10 flex flex-col items-center py-10 space-y-24">
         <div className="rotate-90 origin-center whitespace-nowrap text-[10px] font-black tracking-[0.5em] uppercase opacity-40">Gemini 强力驱动的小说工坊</div>
         <div className="rotate-90 origin-center whitespace-nowrap text-[10px] font-black tracking-[0.5em] uppercase opacity-40">创办于 2024</div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-12 overflow-y-auto">
        <div className="max-w-3xl w-full grid grid-cols-1 md:grid-cols-2 gap-20">
          <div className="flex flex-col justify-center space-y-6">
             <div className="text-[10px] font-black tracking-[0.4em] uppercase opacity-40">小说 · 声音 · 意境</div>
          ...
          <div className="flex flex-col justify-center space-y-10">
             ...
             >
               ...
               <div className="text-[10px] font-black tracking-widest uppercase opacity-60 group-hover:opacity-100">支持拖拽 TXT 或 EPUB 文件到此处</div>
